-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.2.3 to 2.3.0
-- generated by tools/build-extension-update-files
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- remove functions no longer in the 2.3.0 extension
DROP FUNCTION IF EXISTS _pgr_checkverttab(text,text[],in int ,in text ,out text,out text);
DROP FUNCTION IF EXISTS _pgr_createindex(text,text,text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_createindex(text,text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_dijkstra(text,bigint,bigint,boolean,boolean ,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_dijkstra(text,bigint,anyarray,boolean ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_dijkstra(text,anyarray,bigint,boolean ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_dijkstra(text,anyarray,anyarray,boolean ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_drivingdistance(text,bigint,float8,boolean,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_drivingdistance(text,anyarray,float8,boolean,boolean,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_endpoint(geometry);
DROP FUNCTION IF EXISTS _pgr_getcolumnname(text,text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_getcolumnname(text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_getcolumntype(text,text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_getcolumntype(text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_gettablename(in text,in int ,in text ,out text,out text);
DROP FUNCTION IF EXISTS _pgr_get_statement(text);
DROP FUNCTION IF EXISTS _pgr_iscolumnintable(text,text);
DROP FUNCTION IF EXISTS _pgr_iscolumnindexed(text,text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_iscolumnindexed(text,text,in int ,in text );
DROP FUNCTION IF EXISTS _pgr_ksp(text,bigint,bigint,integer,boolean,boolean,out integer,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_makedistancematrix(text,out double precision[],out integer[]);
DROP FUNCTION IF EXISTS _pgr_msg(in int,in text,in text );
DROP FUNCTION IF EXISTS _pgr_onerror(in boolean,in int,in text,in text,in text ,in text );
...
DROP FUNCTION IF EXISTS _pgr_withpoints(text,text,bigint,bigint,boolean,char,boolean,boolean ,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_withpoints(text,text,bigint,anyarray,boolean,char,boolean,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_withpoints(text,text,anyarray,bigint,boolean,char,boolean,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_withpoints(text,text,anyarray,anyarray,boolean,char,boolean,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_withpointsvia(text,bigint[],float[],boolean ,out integer,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float,out float);
DROP FUNCTION IF EXISTS pgr_alphashape(text,float8 ,out float8,out float8);
...
DROP FUNCTION IF EXISTS pgr_dijkstra(text,bigint,bigint,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_dijkstra(text,bigint,bigint,boolean,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_dijkstra(text,bigint,anyarray,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_dijkstra(text,integer,integer,boolean,boolean);
DROP FUNCTION IF EXISTS pgr_dijkstra(text,anyarray,bigint,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_dijkstra(text,anyarray,anyarray,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,bigint,bigint,boolean ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,bigint,anyarray,boolean ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,anyarray,bigint,boolean ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_dijkstracost(text,anyarray,anyarray,boolean ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_dijkstravia(text,anyarray,boolean ,boolean ,boolean ,out integer,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float,out float);
DROP FUNCTION IF EXISTS pgr_drivingdistance(text,bigint,float8,boolean,boolean);
DROP FUNCTION IF EXISTS pgr_drivingdistance(text,bigint,float8,boolean ,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_drivingdistance(text,anyarray,float8,boolean ,boolean ,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_endpoint(geometry);
DROP FUNCTION IF EXISTS pgr_flipedges(geometry[]);
DROP FUNCTION IF EXISTS pgr_floydwarshall(text,boolean ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_getcolumnname(text,text);
DROP FUNCTION IF EXISTS pgr_gettablename(in text,out text,out text);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_gsoc_vrppdtw(text,integer,integer,out integer,out integer,out integer,out integer );
DROP FUNCTION IF EXISTS pgr_gsoc_vrppdtw(text,integer,integer,out integer,out integer,out integer,out integer );
DROP FUNCTION IF EXISTS pgr_iscolumnintable(text,text);
DROP FUNCTION IF EXISTS pgr_iscolumnindexed(text,text);
DROP FUNCTION IF EXISTS pgr_johnson(text,boolean ,out bigint,out bigint,out float);
...
DROP FUNCTION IF EXISTS pgr_ksp(text,bigint,bigint,integer,boolean ,boolean ,out integer,out integer,out integer,out bigint,out bigint,out float,out float);
...
DROP FUNCTION IF EXISTS pgr_pointsaspolygon(varchar,float8 );
DROP FUNCTION IF EXISTS pgr_pointstodmatrix(geometry[],integer );
DROP FUNCTION IF EXISTS pgr_pointstovids(geometry[],text,float8 );
DROP FUNCTION IF EXISTS pgr_pointtoedgenode(text,geometry,float8);
...
DROP FUNCTION IF EXISTS pgr_trspviaedges(text,integer[],float8[],boolean,boolean,text );
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_vidstodmatrix(text,integer[],bool,bool,bool);
DROP FUNCTION IF EXISTS pgr_vidstodmatrix(text,integer[],bool,bool,bool);
DROP FUNCTION IF EXISTS pgr_vidstodmatrix(in integer[],in geometry[],in text,float8 );
DROP FUNCTION IF EXISTS pgr_vrponedepot(text,text,text,integer,out integer,out integer,out integer,out integer,out integer);
DROP FUNCTION IF EXISTS pgr_withpoints(text,text,bigint,bigint,boolean ,char ,boolean ,out integer,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpoints(text,text,bigint,anyarray,boolean ,char ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpoints(text,text,anyarray,bigint,boolean ,char ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpoints(text,text,anyarray,anyarray,boolean ,char ,boolean ,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpointscost(text,text,bigint,bigint,boolean ,char ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_withpointscost(text,text,bigint,anyarray,boolean ,char ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_withpointscost(text,text,anyarray,bigint,boolean ,char ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_withpointscost(text,text,anyarray,anyarray,boolean ,char ,out bigint,out bigint,out float);
DROP FUNCTION IF EXISTS pgr_withpointsdd(text,text,anyarray,float,boolean ,char ,boolean ,boolean ,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpointsdd(text,text,bigint,float,boolean ,char ,boolean ,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_withpointsksp(text,text,bigint,bigint,integer,boolean ,boolean ,char ,boolean ,out integer,out integer,out integer,out bigint,out bigint,out float,out float);
