-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.0.0 to 2.3.0
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp(text,integer,float8,integer,float8,boolean,boolean,text);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_tsp(float8[][],integer,integer,out integer,out integer);
