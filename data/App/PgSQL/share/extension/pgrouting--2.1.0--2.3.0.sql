-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 2.1.0 to 2.3.0
...
DROP FUNCTION IF EXISTS _pgr_createindex(text,text,text,in int ,in text );
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_dijkstra(text,bigint,bigint,boolean,boolean,out integer,out integer,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_dijkstra(text,bigint,anyarray,boolean,boolean,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_dijkstra(text,anyarray,anyarray,boolean,boolean,out integer,out integer,out bigint,out bigint,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_dijkstra(text,anyarray,bigint,boolean,boolean,out integer,out integer,out bigint,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_drivingdistance(text,anyarray,float8,boolean,boolean,boolean,out integer,out bigint,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_drivingdistance(text,anyarray,float8,boolean,boolean,boolean,out integer,out bigint,out bigint,out bigint,out float,out float);
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_drivingdistance(text,bigint,float8,boolean,boolean,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS _pgr_drivingdistance(text,bigint,float8,boolean,boolean,out integer,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_drivingdistance(text,bigint,float8,out integer,out bigint,out bigint,out float,out float);
DROP FUNCTION IF EXISTS pgr_drivingdistance(text,bigint,float8,out integer,out bigint,out bigint,out float,out float);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_drivingdistance(text,bigint,float8,boolean,out integer,out bigint,out bigint,out float,out float);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp(text,integer[],float8[],boolean,boolean,text );
DROP FUNCTION IF EXISTS pgr_trsp(text,integer[],float8[],boolean,boolean,text );
