...
BEGIN
    RETURN QUERY SELECT '2.3.0'::varchar AS version, 
    					'pgrouting-2.3.0'::varchar AS tag, 
                        --'2.3.0'::varchar AS build, 
                        '8c86efd'::varchar AS hash, 
...
CREATE OR REPLACE FUNCTION _pgr_dijkstra(edges_sql TEXT, start_vid BIGINT, end_vid BIGINT, directed BOOLEAN,
 ...
 '$libdir/libpgrouting-2.3', 'one_to_one_dijkstra'
...
CREATE OR REPLACE FUNCTION _pgr_dijkstra(edges_sql TEXT, start_vid BIGINT, end_vids ANYARRAY, directed BOOLEAN DEFAULT true,
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'one_to_many_dijkstra'
    LANGUAGE c IMMUTABLE STRICT;
...
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'many_to_one_dijkstra'
LANGUAGE c IMMUTABLE STRICT;
...
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'many_to_many_dijkstra'
LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_dijkstraVia(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'dijkstraVia'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_johnson(edges_sql TEXT, directed BOOLEAN DEFAULT TRUE,
  OUT start_vid BIGINT, OUT end_vid BIGINT, OUT agg_cost float)
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'johnson'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_floydWarshall(edges_sql TEXT, directed BOOLEAN DEFAULT TRUE, 
  OUT start_vid BIGINT, OUT end_vid BIGINT, OUT agg_cost float)
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'floydWarshall'  
    LANGUAGE c IMMUTABLE STRICT;
...
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'astarOneToOne'
LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_withPointsDD(
    ...
    OUT agg_cost FLOAT)
  RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.3', 'withPoints_dd'
...
CREATE OR REPLACE FUNCTION pgr_withPointsDD(
    ...
    OUT agg_cost FLOAT)
  RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.3', 'many_withPointsDD'
 LANGUAGE c VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_drivingDistance(edges_sql text, start_vid bigint, distance float8, directed BOOLEAN, 
  ...
  RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.3', 'driving_distance'
 LANGUAGE c VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_drivingDistance(edges_sql text, start_vids anyarray, distance float8, directed BOOLEAN, equicost BOOLEAN, 
  ...
  RETURNS SETOF RECORD AS
     '$libdir/libpgrouting-2.3', 'driving_many_to_dist'
 LANGUAGE c VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_ksp(edges_sql text, start_vid bigint, end_vid bigint, k integer, directed boolean, heap_paths boolean,
  ...
  RETURNS SETOF RECORD AS
    '$libdir/libpgrouting-2.3', 'kshortest_path'
...
CREATE OR REPLACE FUNCTION pgr_withPointsKSP(
  ...
  RETURNS SETOF RECORD AS
    '$libdir/libpgrouting-2.3', 'withPoints_ksp'
    LANGUAGE c STABLE STRICT;
...
--CREATE OR REPLACE FUNCTION pgr_tsp(matrix float8[][], startpt integer, OUT seq integer, OUT id integer)
    RETURNS SETOF record
    AS '$libdir/libpgrouting-2.3', 'tsp_matrix'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_TSP(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF record
AS '$libdir/libpgrouting-2.3', 'newTSP'
LANGUAGE c VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_eucledianTSP(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF record
AS '$libdir/libpgrouting-2.3', 'eucledianTSP'
LANGUAGE c VOLATILE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_alphashape(sql text, alpha float8 DEFAULT 0, OUT x float8, OUT y float8)
    RETURNS SETOF record
    AS '$libdir/libpgrouting-2.3', 'alphashape'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_bdAstar(
        ...
        AS '$libdir/libpgrouting-2.3', 'bidir_astar_shortest_path'
        LANGUAGE 'c' IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_bdDijkstra(
        ...
        has_reverse_cost boolean)
        RETURNS SETOF pgr_costResult
        AS '$libdir/libpgrouting-2.3', 'bidir_dijkstra_shortest_path'
        LANGUAGE c IMMUTABLE STRICT;
...
RETURNS SETOF pgr_costResult
AS '$libdir/libpgrouting-2.3', 'turn_restrict_shortest_path_vertex'
...
CREATE OR REPLACE FUNCTION pgr_trsp(
    ...
    turn_restrict_sql text DEFAULT null)
RETURNS SETOF pgr_costResult
AS '$libdir/libpgrouting-2.3', 'turn_restrict_shortest_path_edge'
LANGUAGE 'c' IMMUTABLE;
...
CREATE OR REPLACE FUNCTION _pgr_maxflow(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'max_flow_one_to_one'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_maxflow(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'max_flow_one_to_many'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_maxflow(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'max_flow_many_to_one'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_maxflow(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'max_flow_many_to_many'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_maximumcardinalitymatching(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'maximum_cardinality_matching'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'edge_disjoint_paths_one_to_one'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'edge_disjoint_paths_one_to_many'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'edge_disjoint_paths_many_to_one'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_edgeDisjointPaths(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'edge_disjoint_paths_many_to_many'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION pgr_contractGraph(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'contractGraph'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_pickDeliver(
  ...
  RETURNS SETOF RECORD AS
 '$libdir/libpgrouting-2.3', 'pickDeliver'
    LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_withPoints(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'one_to_one_withPoints'
LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_withPoints(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'one_to_many_withPoints'
LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_withPoints(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'many_to_one_withPoints'
LANGUAGE c IMMUTABLE STRICT;
...
CREATE OR REPLACE FUNCTION _pgr_withPoints(
    ...
    OUT agg_cost FLOAT)
RETURNS SETOF RECORD AS
'$libdir/libpgrouting-2.3', 'many_to_many_withPoints'
LANGUAGE c IMMUTABLE STRICT;
